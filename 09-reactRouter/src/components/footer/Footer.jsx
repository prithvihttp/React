...
export default function Footer() {
  return (
    <footer className="w-screen bg-gradient-to-tr from-indigo-100 via-white to-cyan-100 border-t border-indigo-200 shadow-md">
          ...
          <div className="grid grid-cols-2 gap-10 sm:grid-cols-3">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>
                  <a
                    href="https://github.com/prithvihttp"
                    target="_blank"
                    rel="noreferrer"
                    className="hover:text-orange-600 transition-colors"
                  >
